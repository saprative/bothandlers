...
This file covers Gemini-specific configuration only.

## Purpose

- Define Gemini-specific system prompts for BotHandlers' own use of Gemini.
- Outline Gemini's tool-use capabilities and limitations relevant to the MCP surface
  ...
  see `vission.md` §8).
- Document Gemini-specific token and cost considerations.
